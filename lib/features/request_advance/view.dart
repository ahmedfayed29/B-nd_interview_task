...
import 'package:hr_app/features/advance_history/view.dart';
import 'package:hr_app/features/request_advance/request_advance_cubit.dart';
...
class RequestAdvanceView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      ...
      floatingActionButton:
          HistoryWidget(onTap: () => RouteUtils.navigateTo(AdvanceHistory())),
      page: BlocProvider(
        create: (context) => RequestAdvanceCubit(),
        child: BlocBuilder<RequestAdvanceCubit, RequestAdvanceState>(
